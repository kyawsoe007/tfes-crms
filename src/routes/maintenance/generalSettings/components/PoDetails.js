...
//DUCKS
import {getAllApprovalRights,patchApprovalRight,postApprovalRight,deleteApprovalRight} from "Ducks/general-setting/approval-right"

const PoDetails = ({
    getAllApprovalRights,
    approvalRightsAll,
    patchApprovalRight,
    deleteApprovalRight,
    postApprovalRight,
    ...
    const tableOptions = {
        ...
        customToolbar: () => (
            <React.Fragment>
            <Tooltip id="tooltip-icon" title="Add PO Approval">
              <IconButton className="mr-2" aria-label="PO Approval" 
               onClick={() => {
