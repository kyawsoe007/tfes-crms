...
class FormInputMultilines extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <FormControl className={classes.root}>
        ...
        {selectValues ? (
          ...
          <TextareaAutosize
            ...
            disabled={disabled}
            style={{ color: this.state.formColor , border: "1px solid #ced4da",    borderRadius: "6px" ,resize: "none"}}
            {...others}
          />
        )}
...
export default withStyles(styles)(FormInputMultilines);
